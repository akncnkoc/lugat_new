    ...
    <div className={clsx('grid', 'grid-cols-8', 'gap-x-2', 'place-content-center')}>
      <div className={'flex-col col-span-6'}>
        <Card>
          ...
          <Card.Body className={clsx(productCreateFormik.values.have_variants && ['rounded-bl-2xl', 'rounded-br-2xl'])}>
            <SeperatedColumn>
              <SeperatedRow>
                <LugatInput
                  required
              ...
              <SeperatedRow>
                <LugatCurrencyInputWithAsyncSelect
                  input={{
                    label: 'Buy Price',
                    required: true,
                    error: productCreateFormik.touched.buy_price && productCreateFormik.errors.buy_price,
                  ...
                  select={{
                    error:
                      getIn(productCreateFormik.touched, 'buy_currency.value') && getIn(productCreateFormik.errors, 'buy_currency.value'),
              ...
              <SeperatedRow>
                <LugatCurrencyInputWithAsyncSelect
                  input={{
                    label: 'Sell Price',
                    required: true,
                    error: productCreateFormik.touched.sell_price && productCreateFormik.errors.sell_price,
                  ...
                  select={{
                    error:
                      getIn(productCreateFormik.touched, 'sell_currency.value') && getIn(productCreateFormik.errors, 'sell_currency.value'),
          ...
          {!productCreateFormik.values.have_variants && (
            <Card.Footer>
              <LugatButton onClick={productCreateFormik.submitForm}>{!isLoading ? 'Save' : <LoaderIcon />}</LugatButton>
            </Card.Footer>
          )}
        </Card>
        {productCreateFormik.values.have_variants && (
