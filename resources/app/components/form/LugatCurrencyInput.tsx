...
const LugatCurrencyInput = forwardRef<typeof CurrencyInput, LugatCurrencyInputProps>((props, _) => (
  <div className={'flex-1'}>
    ...
    />
    {props.error && (
      <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className='mt-2 text-sm text-red-600 font-semibold'>
        {props.error}
      </motion.p>
    )}
  </div>
