...
const CardHeader: React.FC<CardHeaderProps> = (props) => {
  return (
    <div className={clsx('h-16', 'px-6', 'border-b', 'border-gray-100', 'flex', 'items-center', 'justify-between')}>{props.children}</div>
  )
}
  ...
  return (
    <div
      className={clsx(
        ...
        'pb-4',
        'py-4',
        [props.withoutFooter ? ['rounded-bl-2xl', 'rounded-br-2xl'] : null],
        props.className,
      )}
    >
...
const CardFooter: React.FC<CardFooterProps> = (props) => {
  return (
    <div className={clsx('bg-white', 'p-4', 'flex', 'justify-end', 'border-t', 'border-gray-50', 'rounded-bl-2xl', 'rounded-br-2xl')}>
      {props.children}
    </div>
  )
}
